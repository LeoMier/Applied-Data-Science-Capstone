...
def get_pie_chart(chart):
    ...
    """if chart == 'OPT1':
        pie_1 = spacex_df[spacex_df['Launch Site'] == 'CCAFS LC-40']
        pie_fig_1 = px.pie(pie_1, values=pie['class'].values, names=)"""
